...
from src.agents.enhanced_technical_analyst import EnhancedTechnicalAnalyst, EnhancedTechnicalOutput as EnhancedTechnicalAnalysisOutput
from src.agents.visual_analyst_enhanced import EnhancedVisualAnalystAgent, EnhancedVisualChartAnalysisOutput
from src.agents.decision import EnhancedDecisionAgent, FinalDecisionOutput
from src.agents.enhanced_qabba_agent import EnhancedQABBAAgent, EnhancedQabbaOutput as QABBAAnalysisOutput
from src.agents.risk import AdvancedRiskManager, RiskAssessment, OrderDetails

from src.tools.technical_tools import add_kline as tt_add_kline, get_current_indicators as tt_get_current_indicators, get_indicator_sequences as tt_get_indicator_sequences
...
def get_mock_qabba_output() -> QABBAAnalysisOutput:
    return QABBAAnalysisOutput(qabba_signal="HOLD_QABBA", qabba_confidence=0.50,reasoning_short="Mocked QABBA.")
