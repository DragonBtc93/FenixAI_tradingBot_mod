...
class CircuitBreakerManager:
    ...
    def get_circuit_breaker(self, service_name: str, config: Optional[CircuitBreakerConfig] = None) -> UniversalCircuitBreaker:
...
def get_circuit_breaker(service_name: str, config: Optional[CircuitBreakerConfig] = None) -> UniversalCircuitBreaker:
